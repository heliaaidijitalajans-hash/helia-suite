...
/**
 * Helia Chat — connected to Helia Brain via Suite BFF + Helia Cloud session.
 * Chat UI components stay unchanged; wiring lives in useHeliaChat / services/brain.
 */
export default function HeliaChatPage() {
  const {
    conversations,
